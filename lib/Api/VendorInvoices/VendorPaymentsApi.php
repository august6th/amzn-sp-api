...
namespace SellingPartnerApi\Api\VendorInvoices;
...
class VendorPaymentsApi
{
     ...
     *
     * @param  \SellingPartnerApi\Model\VendorInvoices\SubmitInvoicesRequest $body The request body containing the invoice data to submit. (required)
     *
