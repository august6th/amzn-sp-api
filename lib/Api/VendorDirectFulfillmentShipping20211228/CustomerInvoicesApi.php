...
class CustomerInvoicesApi
{
     ...
     * @return \SellingPartnerApi\Model\VendorDirectFulfillmentShipping20211228\CustomerInvoice
     */
     ...
     * @throws \SellingPartnerApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SellingPartnerApi\Model\VendorDirectFulfillmentShipping20211228\CustomerInvoice, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCustomerInvoiceWithHttpInfo($purchaseOrderNumber)
    {
        $returnType = '\SellingPartnerApi\Model\VendorDirectFulfillmentShipping20211228\CustomerInvoice';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SellingPartnerApi\Model\VendorDirectFulfillmentShipping20211228\CustomerInvoice',
     ...
     * @throws \SellingPartnerApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SellingPartnerApi\Model\VendorDirectFulfillmentShipping20211228\CustomerInvoiceList
     */
     ...
     * @throws \SellingPartnerApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SellingPartnerApi\Model\VendorDirectFulfillmentShipping20211228\CustomerInvoiceList, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\SellingPartnerApi\Model\VendorDirectFulfillmentShipping20211228\CustomerInvoiceList';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SellingPartnerApi\Model\VendorDirectFulfillmentShipping20211228\CustomerInvoiceList',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
