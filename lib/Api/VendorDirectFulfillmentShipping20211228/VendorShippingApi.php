...
class VendorShippingApi
{
     ...
     * @throws \SellingPartnerApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SellingPartnerApi\Model\VendorDirectFulfillmentShipping20211228\PackingSlip, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPackingSlipWithHttpInfo($purchaseOrderNumber)
    {
        $returnType = '\SellingPartnerApi\Model\VendorDirectFulfillmentShipping20211228\PackingSlip';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SellingPartnerApi\Model\VendorDirectFulfillmentShipping20211228\PackingSlip',
     ...
     * @throws \SellingPartnerApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SellingPartnerApi\Model\VendorDirectFulfillmentShipping20211228\PackingSlipList
     */
     ...
     * @throws \SellingPartnerApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SellingPartnerApi\Model\VendorDirectFulfillmentShipping20211228\PackingSlipList, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\SellingPartnerApi\Model\VendorDirectFulfillmentShipping20211228\PackingSlipList';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SellingPartnerApi\Model\VendorDirectFulfillmentShipping20211228\PackingSlipList',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \SellingPartnerApi\Model\VendorDirectFulfillmentShipping20211228\SubmitShipmentConfirmationsRequest $body Request body containing the shipment confirmations data. (required)
     *
     * @throws \SellingPartnerApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \SellingPartnerApi\Model\VendorDirectFulfillmentShipping20211228\SubmitShipmentStatusUpdatesRequest $body Request body containing the shipment status update data. (required)
     *
     * @throws \SellingPartnerApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SellingPartnerApi\Model\VendorDirectFulfillmentShipping20211228\TransactionReference
