...
namespace SellingPartnerApi\Api\VendorTransactionStatus;
...
class VendorTransactionApi
{
     ...
     *
     * @param  string $transactionId The GUID provided by Amazon in the &#x27;transactionId&#x27; field in response to the post request of a specific transaction. (required)
     *
