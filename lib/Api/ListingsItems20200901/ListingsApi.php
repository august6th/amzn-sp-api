...
namespace SellingPartnerApi\Api\ListingsItems20200901;
...
class ListingsApi
{
     ...
     * @return \SellingPartnerApi\Model\ListingsItems20200901\ListingsItemSubmissionResponse
     */
     ...
     * @throws \SellingPartnerApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SellingPartnerApi\Model\ListingsItems20200901\ListingsItemSubmissionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function deleteListingsItemWithHttpInfo($sellerId, $sku, $marketplaceIds, $issueLocale = null)
    {
        $returnType = '\SellingPartnerApi\Model\ListingsItems20200901\ListingsItemSubmissionResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SellingPartnerApi\Model\ListingsItems20200901\ListingsItemSubmissionResponse',
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SellingPartnerApi\Model\ListingsItems20200901\ErrorList',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \SellingPartnerApi\Model\ListingsItems20200901\ListingsItemPatchRequest $body The request body schema for the patchListingsItem operation. (required)
     * @param  string[] $marketplaceIds A comma-delimited list of Amazon marketplace identifiers for the request. (required)
     * @param  string $sellerId A selling partner identifier, such as a merchant account or vendor code. (required)
     * @param  string $sku A selling partner provided identifier for an Amazon listing. (required)
     * @param  string $issueLocale A locale for localization of issues. When not provided, the default language code of the first marketplace is used. Examples: \&quot;en_US\&quot;, \&quot;fr_CA\&quot;, \&quot;fr_FR\&quot;. Localized messages default to \&quot;en_US\&quot; when a localization is not available in the specified locale. (optional)
     ...
     * @return \SellingPartnerApi\Model\ListingsItems20200901\ListingsItemSubmissionResponse
     */
    public function patchListingsItem($body, $marketplaceIds, $sellerId, $sku, $issueLocale = null)
    {
        list($response) = $this->patchListingsItemWithHttpInfo($body, $marketplaceIds, $sellerId, $sku, $issueLocale);
        return $response;
    }
     ...
     * @return array of \SellingPartnerApi\Model\ListingsItems20200901\ListingsItemSubmissionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function patchListingsItemWithHttpInfo($body, $marketplaceIds, $sellerId, $sku, $issueLocale = null)
    {
        $returnType = '\SellingPartnerApi\Model\ListingsItems20200901\ListingsItemSubmissionResponse';
        $request = $this->patchListingsItemRequest($body, $marketplaceIds, $sellerId, $sku, $issueLocale);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchListingsItemAsync($body, $marketplaceIds, $sellerId, $sku, $issueLocale = null)
    {
        return $this->patchListingsItemAsyncWithHttpInfo($body, $marketplaceIds, $sellerId, $sku, $issueLocale)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchListingsItemAsyncWithHttpInfo($body, $marketplaceIds, $sellerId, $sku, $issueLocale = null)
    {
        $returnType = '\SellingPartnerApi\Model\ListingsItems20200901\ListingsItemSubmissionResponse';
        $request = $this->patchListingsItemRequest($body, $marketplaceIds, $sellerId, $sku, $issueLocale);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function patchListingsItemRequest($body, $marketplaceIds, $sellerId, $sku, $issueLocale = null)
    {
     ...
     *
     * @param  \SellingPartnerApi\Model\ListingsItems20200901\ListingsItemPutRequest $body The request body schema for the putListingsItem operation. (required)
     * @param  string[] $marketplaceIds A comma-delimited list of Amazon marketplace identifiers for the request. (required)
     * @param  string $sellerId A selling partner identifier, such as a merchant account or vendor code. (required)
     * @param  string $sku A selling partner provided identifier for an Amazon listing. (required)
     * @param  string $issueLocale A locale for localization of issues. When not provided, the default language code of the first marketplace is used. Examples: \&quot;en_US\&quot;, \&quot;fr_CA\&quot;, \&quot;fr_FR\&quot;. Localized messages default to \&quot;en_US\&quot; when a localization is not available in the specified locale. (optional)
     ...
     * @return \SellingPartnerApi\Model\ListingsItems20200901\ListingsItemSubmissionResponse
     */
    public function putListingsItem($body, $marketplaceIds, $sellerId, $sku, $issueLocale = null)
    {
        list($response) = $this->putListingsItemWithHttpInfo($body, $marketplaceIds, $sellerId, $sku, $issueLocale);
        return $response;
    }
     ...
     * @return array of \SellingPartnerApi\Model\ListingsItems20200901\ListingsItemSubmissionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function putListingsItemWithHttpInfo($body, $marketplaceIds, $sellerId, $sku, $issueLocale = null)
    {
        $returnType = '\SellingPartnerApi\Model\ListingsItems20200901\ListingsItemSubmissionResponse';
        $request = $this->putListingsItemRequest($body, $marketplaceIds, $sellerId, $sku, $issueLocale);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putListingsItemAsync($body, $marketplaceIds, $sellerId, $sku, $issueLocale = null)
    {
        return $this->putListingsItemAsyncWithHttpInfo($body, $marketplaceIds, $sellerId, $sku, $issueLocale)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putListingsItemAsyncWithHttpInfo($body, $marketplaceIds, $sellerId, $sku, $issueLocale = null)
    {
        $returnType = '\SellingPartnerApi\Model\ListingsItems20200901\ListingsItemSubmissionResponse';
        $request = $this->putListingsItemRequest($body, $marketplaceIds, $sellerId, $sku, $issueLocale);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function putListingsItemRequest($body, $marketplaceIds, $sellerId, $sku, $issueLocale = null)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
