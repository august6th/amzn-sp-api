...
class OrdersV0Api
{
     ...
     *
     * @param  \SellingPartnerApi\Model\OrdersV0\ConfirmShipmentRequest $body Request body of &#x60;confirmShipment&#x60;. (required)
     ...
     * @return void
     */
    public function confirmShipment($body, $orderId)
    {
        $this->confirmShipmentWithHttpInfo($body, $orderId);
    }
     ...
     */
    public function confirmShipmentWithHttpInfo($body, $orderId)
    {
        $returnType = '';
        $request = $this->confirmShipmentRequest($body, $orderId);
     ...
     */
    public function confirmShipmentAsync($body, $orderId)
    {
        return $this->confirmShipmentAsyncWithHttpInfo($body, $orderId)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function confirmShipmentAsyncWithHttpInfo($body, $orderId)
    {
        $returnType = '';
        $request = $this->confirmShipmentRequest($body, $orderId);
     ...
     */
    protected function confirmShipmentRequest($body, $orderId)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling confirmShipment'
            );
        }
     ...
     *
     * @param  string $orderId The Amazon order identifier in 3-7-7 format. (required)
     *
     * @throws \SellingPartnerApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @throws \SellingPartnerApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SellingPartnerApi\Model\OrdersV0\GetOrderFulfillmentInstructionsResponse
     */
    public function getOrderFulfillmentInstructions($orderId)
    {
        list($response) = $this->getOrderFulfillmentInstructionsWithHttpInfo($orderId);
        return $response;
    }
     ...
     * @throws \SellingPartnerApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SellingPartnerApi\Model\OrdersV0\GetOrderFulfillmentInstructionsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrderFulfillmentInstructionsWithHttpInfo($orderId)
    {
        $returnType = '\SellingPartnerApi\Model\OrdersV0\GetOrderFulfillmentInstructionsResponse';
        $request = $this->getOrderFulfillmentInstructionsRequest($orderId);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SellingPartnerApi\Model\OrdersV0\GetOrderFulfillmentInstructionsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrderFulfillmentInstructionsAsync($orderId)
    {
        return $this->getOrderFulfillmentInstructionsAsyncWithHttpInfo($orderId)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrderFulfillmentInstructionsAsyncWithHttpInfo($orderId)
    {
        $returnType = '\SellingPartnerApi\Model\OrdersV0\GetOrderFulfillmentInstructionsResponse';
        $request = $this->getOrderFulfillmentInstructionsRequest($orderId);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getOrderFulfillmentInstructionsRequest($orderId)
    {
        // verify the required parameter 'orderId' is set
        if ($orderId === null || (is_array($orderId) && count($orderId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $orderId when calling getOrderFulfillmentInstructions'
            );
        }
     ...
     * Operation getOrders
     *
     * @param  string[] $marketplaceIds A list of &#x60;MarketplaceId&#x60; values. Used to select orders that were placed in the specified marketplaces.  Refer to [Marketplace IDs](https://developer-docs.amazon.com/sp-api/docs/marketplace-ids) for a complete list of &#x60;marketplaceId&#x60; values. (required)
     ...
     * @param  string[] $fulfillmentChannels A list that indicates how an order was fulfilled. Filters the results by fulfillment channel.   **Possible values**: &#x60;AFN&#x60; (fulfilled by Amazon), &#x60;MFN&#x60; (fulfilled by seller). (optional)
     * @param  string[] $paymentMethods A list of payment method values. Use this field to select orders that were paid with the specified payment methods.  **Possible values**: &#x60;COD&#x60; (cash on delivery), &#x60;CVS&#x60; (convenience store), &#x60;Other&#x60; (Any payment method other than COD or CVS). (optional)
     * @param  string $sellerOrderId An order identifier that is specified by the seller. Used to select only the orders that match the order identifier. If &#x60;SellerOrderId&#x60; is specified, then &#x60;FulfillmentChannels&#x60;, &#x60;OrderStatuses&#x60;, &#x60;PaymentMethod&#x60;, &#x60;LastUpdatedAfter&#x60;, and &#x60;LastUpdatedBefore&#x60; cannot be specified. (optional)
     ...
     * @param  string $actualFulfillmentSupplySourceId The &#x60;sourceId&#x60; of the location from where you want the order fulfilled. (optional)
     ...
     * @param  string $earliestDeliveryDateBefore Use this date to select orders with an earliest delivery date before (or at) a specified time. The date must be in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) format. (optional)
     * @param  string $earliestDeliveryDateAfter Use this date to select orders with an earliest delivery date after (or at) a specified time. The date must be in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) format. (optional)
     * @param  string $latestDeliveryDateBefore Use this date to select orders with a latest delivery date before (or at) a specified time. The date must be in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) format. (optional)
     * @param  string $latestDeliveryDateAfter Use this date to select orders with a latest delivery date after (or at) a specified time. The date must be in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) format. (optional)
     *
     * @throws \SellingPartnerApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SellingPartnerApi\Model\OrdersV0\GetOrdersResponse
     */
    public function getOrders($marketplaceIds, $createdAfter = null, $createdBefore = null, $lastUpdatedAfter = null, $lastUpdatedBefore = null, $orderStatuses = null, $fulfillmentChannels = null, $paymentMethods = null, $sellerOrderId = null, $maxResultsPerPage = null, $easyShipShipmentStatuses = null, $electronicInvoiceStatuses = null, $nextToken = null, $amazonOrderIds = null, $actualFulfillmentSupplySourceId = null, $isISPU = null, $storeChainStoreId = null, $earliestDeliveryDateBefore = null, $earliestDeliveryDateAfter = null, $latestDeliveryDateBefore = null, $latestDeliveryDateAfter = null)
    {
    ...
    protected function getOrdersRequest($marketplaceIds, $createdAfter = null, $createdBefore = null, $lastUpdatedAfter = null, $lastUpdatedBefore = null, $orderStatuses = null, $fulfillmentChannels = null, $paymentMethods = null, $sellerOrderId = null, $maxResultsPerPage = null, $easyShipShipmentStatuses = null, $electronicInvoiceStatuses = null, $nextToken = null, $amazonOrderIds = null, $actualFulfillmentSupplySourceId = null, $isISPU = null, $storeChainStoreId = null, $earliestDeliveryDateBefore = null, $earliestDeliveryDateAfter = null, $latestDeliveryDateBefore = null, $latestDeliveryDateAfter = null)
    {
        ...
        if ($orderStatuses !== null) {
            $queryParams['OrderStatuses'] = ObjectSerializer::toQueryValue($orderStatuses, null);
        }
        // query params
        ...
        if ($fulfillmentChannels !== null) {
            $queryParams['FulfillmentChannels'] = ObjectSerializer::toQueryValue($fulfillmentChannels, null);
        }
        // query params
        ...
        if ($paymentMethods !== null) {
            $queryParams['PaymentMethods'] = ObjectSerializer::toQueryValue($paymentMethods, null);
        }
        // query params
        if ($sellerOrderId !== null) {
            $queryParams['SellerOrderId'] = ObjectSerializer::toQueryValue($sellerOrderId, null);
        }
        // query params
        ...
        if ($easyShipShipmentStatuses !== null) {
            $queryParams['EasyShipShipmentStatuses'] = ObjectSerializer::toQueryValue($easyShipShipmentStatuses, null);
        }
        // query params
        ...
        if ($electronicInvoiceStatuses !== null) {
            $queryParams['ElectronicInvoiceStatuses'] = ObjectSerializer::toQueryValue($electronicInvoiceStatuses, null);
        }
        // query params
        if ($nextToken !== null) {
            $queryParams['NextToken'] = ObjectSerializer::toQueryValue($nextToken, null);
        ...
        if ($amazonOrderIds !== null) {
            $queryParams['AmazonOrderIds'] = ObjectSerializer::toQueryValue($amazonOrderIds, null);
        }
        // query params
        if ($actualFulfillmentSupplySourceId !== null) {
            $queryParams['ActualFulfillmentSupplySourceId'] = ObjectSerializer::toQueryValue($actualFulfillmentSupplySourceId, null);
        }
        // query params
        if ($isISPU !== null) {
            $queryParams['IsISPU'] = ObjectSerializer::toQueryValue($isISPU, null);
        }
        // query params
        if ($storeChainStoreId !== null) {
            $queryParams['StoreChainStoreId'] = ObjectSerializer::toQueryValue($storeChainStoreId, null);
        }
        // query params
        if ($earliestDeliveryDateBefore !== null) {
            $queryParams['EarliestDeliveryDateBefore'] = ObjectSerializer::toQueryValue($earliestDeliveryDateBefore, null);
        }
        // query params
        if ($earliestDeliveryDateAfter !== null) {
            $queryParams['EarliestDeliveryDateAfter'] = ObjectSerializer::toQueryValue($earliestDeliveryDateAfter, null);
        }
        // query params
        if ($latestDeliveryDateBefore !== null) {
            $queryParams['LatestDeliveryDateBefore'] = ObjectSerializer::toQueryValue($latestDeliveryDateBefore, null);
        }
        // query params
        if ($latestDeliveryDateAfter !== null) {
            $queryParams['LatestDeliveryDateAfter'] = ObjectSerializer::toQueryValue($latestDeliveryDateAfter, null);
        }
     ...
     *
     * @param  \SellingPartnerApi\Model\OrdersV0\UpdateVerificationStatusRequest $body The request body for the &#x60;updateVerificationStatus&#x60; operation. (required)
     * @param  string $orderId The Amazon order identifier in 3-7-7 format. (required)
     *
     * @throws \SellingPartnerApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function updateVerificationStatus($body, $orderId)
    {
        $this->updateVerificationStatusWithHttpInfo($body, $orderId);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateVerificationStatusWithHttpInfo($body, $orderId)
    {
        $returnType = '';
        $request = $this->updateVerificationStatusRequest($body, $orderId);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateVerificationStatusAsync($body, $orderId)
    {
        return $this->updateVerificationStatusAsyncWithHttpInfo($body, $orderId)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateVerificationStatusAsyncWithHttpInfo($body, $orderId)
    {
        $returnType = '';
        $request = $this->updateVerificationStatusRequest($body, $orderId);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateVerificationStatusRequest($body, $orderId)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling updateVerificationStatus'
            );
        }
        // verify the required parameter 'orderId' is set
        if ($orderId === null || (is_array($orderId) && count($orderId) === 0)) {
