...
class SalesApi
{
     ...
     */
    protected function getOrderMetricsRequest($marketplaceIds, $interval, $granularity, $granularityTimeZone = null, $buyerType = 'All', $fulfillmentNetwork = null, $firstDayOfWeek = 'Monday', $asin = null, $sku = null, $amazonProgram = null)
    {
        ...
        if ($amazonProgram !== null) {
            $queryParams['amazonProgram'] = ObjectSerializer::toQueryValue($amazonProgram, null);
        }
