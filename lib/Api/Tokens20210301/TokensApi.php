...
namespace SellingPartnerApi\Api\Tokens20210301;
...
class TokensApi
{
     ...
     *
     * @param  \SellingPartnerApi\Model\Tokens20210301\CreateRestrictedDataTokenRequest $body The restricted data token request details. (required)
     *
     * @throws \SellingPartnerApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SellingPartnerApi\Model\Tokens20210301\CreateRestrictedDataTokenResponse
     */
     ...
     * @throws \SellingPartnerApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SellingPartnerApi\Model\Tokens20210301\CreateRestrictedDataTokenResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createRestrictedDataTokenWithHttpInfo($body)
    {
        $returnType = '\SellingPartnerApi\Model\Tokens20210301\CreateRestrictedDataTokenResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SellingPartnerApi\Model\Tokens20210301\CreateRestrictedDataTokenResponse',
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SellingPartnerApi\Model\Tokens20210301\ErrorList',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
