...
namespace SellingPartnerApi\Api\FbaInbound;
...
class FbaInboundApi
{
     ...
     * @return \SellingPartnerApi\Model\FbaInbound\GetItemEligibilityPreviewResponse
     */
     ...
     * @throws \SellingPartnerApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SellingPartnerApi\Model\FbaInbound\GetItemEligibilityPreviewResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getItemEligibilityPreviewWithHttpInfo($asin, $program, $marketplaceIds = null)
    {
        $returnType = '\SellingPartnerApi\Model\FbaInbound\GetItemEligibilityPreviewResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SellingPartnerApi\Model\FbaInbound\GetItemEligibilityPreviewResponse',
