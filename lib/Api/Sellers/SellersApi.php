...
namespace SellingPartnerApi\Api\Sellers;
...
class SellersApi
{
     ...
     * @return \SellingPartnerApi\Model\Sellers\GetAccountResponse
     */
     ...
     * @throws \SellingPartnerApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SellingPartnerApi\Model\Sellers\GetAccountResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAccountWithHttpInfo()
    {
        $returnType = '\SellingPartnerApi\Model\Sellers\GetAccountResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SellingPartnerApi\Model\Sellers\GetAccountResponse',
