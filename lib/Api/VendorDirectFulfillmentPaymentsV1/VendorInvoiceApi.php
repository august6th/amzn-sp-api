...
namespace SellingPartnerApi\Api\VendorDirectFulfillmentPaymentsV1;
...
class VendorInvoiceApi
{
     ...
     *
     * @param  \SellingPartnerApi\Model\VendorDirectFulfillmentPaymentsV1\SubmitInvoiceRequest $body The request body containing one or more invoices for vendor orders. (required)
     *
