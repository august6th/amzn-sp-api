...
class MarketplaceTaxInfo implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'taxClassifications' => '\SellingPartnerApi\Model\OrdersV0\TaxClassification[]'
    ];
     ...
     *
     * @param \SellingPartnerApi\Model\OrdersV0\TaxClassification[] $taxClassifications A list of tax classifications that apply to the order.
     *
     * @return $this
     */
