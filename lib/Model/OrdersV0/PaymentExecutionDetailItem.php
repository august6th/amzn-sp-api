...
class PaymentExecutionDetailItem implements ModelInterface, ArrayAccess
{
     ...
     * Sets acquirerId
     *
     * @param string $acquirerId The Brazilian Taxpayer Identifier (CNPJ) of the payment processor or acquiring bank that authorizes the payment.   **Note**: This attribute is only available for orders in the Brazil (BR) marketplace when the `PaymentMethod` is `CreditCard` or `Pix`.
     *
     * @return $this
     */
     ...
     * Sets cardBrand
     *
     * @param string $cardBrand The card network or brand used in the payment transaction (for example, Visa or Mastercard).   **Note**: This attribute is only available for orders in the Brazil (BR) marketplace when the `PaymentMethod` is `CreditCard`.
     *
     * @return $this
     */
     ...
     *
     * @param string $authorizationCode The unique code that confirms the payment authorization.   **Note**: This attribute is only available for orders in the Brazil (BR) marketplace when the `PaymentMethod` is `CreditCard` or `Pix`.
     *
     * @return $this
     */
