...
class TransportationDetails implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'trackingDetails' => '\SellingPartnerApi\Model\Awd20240509\TrackingDetails[]'
    ];
     ...
     *
     * @return \SellingPartnerApi\Model\Awd20240509\TrackingDetails[]
     */
     ...
     *
     * @param \SellingPartnerApi\Model\Awd20240509\TrackingDetails[] $trackingDetails Tracking details for the shipment. If using SPD transportation, this can be for each case. If not using SPD transportation, this is a single tracking entry for the entire shipment.
     *
     * @return $this
     */
