...
class TrackingInfo implements ModelInterface, ArrayAccess
{
     ...
     * Sets carrierName
     *
     * @param string $carrierName The name of the third party courier service used to ship the return package.
     *
     * @return $this
     */
     ...
     * Sets trackingId
     *
     * @param string $trackingId The tracking ID of the return package.
     *
     * @return $this
     */
