...
class RemovalShipmentItemAdjustment implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'revenueAdjustment' => '\SellingPartnerApi\Model\FinancesV0\Currency',
        'taxAmountAdjustment' => '\SellingPartnerApi\Model\FinancesV0\Currency',
        'taxWithheldAdjustment' => '\SellingPartnerApi\Model\FinancesV0\Currency'
    ];
     ...
     *
     * @param string $taxCollectionModel The tax collection model that is applied to the item.  Possible values:  * `MarketplaceFacilitator`: Tax is withheld and remitted to the taxing authority by Amazon on behalf of the seller. * `Standard`: Tax is paid to the seller and not remitted to the taxing authority by Amazon.
     *
     * @return $this
     */
     ...
     *
     * @param \SellingPartnerApi\Model\FinancesV0\Currency $revenueAdjustment revenueAdjustment
     *
     * @return $this
     */
     ...
     *
     * @param \SellingPartnerApi\Model\FinancesV0\Currency $taxAmountAdjustment taxAmountAdjustment
     *
     * @return $this
     */
     ...
     *
     * @param \SellingPartnerApi\Model\FinancesV0\Currency $taxWithheldAdjustment taxWithheldAdjustment
     *
     * @return $this
     */
