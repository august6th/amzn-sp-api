...
class NetworkComminglingTransactionEvent implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'taxExclusiveAmount' => '\SellingPartnerApi\Model\FinancesV0\Currency',
     ...
     *
     * @param string $transactionType The type of network item swap.  Possible values:  * `NetCo`: A Fulfillment by Amazon inventory pooling transaction. Available only in the India marketplace.  * `ComminglingVAT`: A commingling VAT transaction. Available only in the Spain, UK, France, Germany, and Italy marketplaces.
     *
     * @return $this
     */
     ...
     *
     * @param \SellingPartnerApi\Model\FinancesV0\Currency $taxExclusiveAmount taxExclusiveAmount
     *
     * @return $this
     */
