...
class ProductAdsPaymentEvent implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'invoiceId' => 'string',
        'baseValue' => '\SellingPartnerApi\Model\FinancesV0\Currency',
        'taxValue' => '\SellingPartnerApi\Model\FinancesV0\Currency',
        'transactionValue' => '\SellingPartnerApi\Model\FinancesV0\Currency'
    ];
     ...
     *
     * @param string $transactionType Indicates if the transaction is for a charge or a refund.  Possible values:  * `charge`  * `refund`
     *
     * @return $this
     */
     ...
     * Sets baseValue
     *
     * @param \SellingPartnerApi\Model\FinancesV0\Currency $baseValue baseValue
     *
     * @return $this
     */
     ...
     * Sets taxValue
     *
     * @param \SellingPartnerApi\Model\FinancesV0\Currency $taxValue taxValue
     *
     * @return $this
     */
     ...
     *
     * @param \SellingPartnerApi\Model\FinancesV0\Currency $transactionValue transactionValue
     *
     * @return $this
     */
