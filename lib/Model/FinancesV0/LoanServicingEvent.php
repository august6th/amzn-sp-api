...
class LoanServicingEvent implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'loanAmount' => '\SellingPartnerApi\Model\FinancesV0\Currency',
     ...
     * Sets loanAmount
     *
     * @param \SellingPartnerApi\Model\FinancesV0\Currency $loanAmount loanAmount
     *
     * @return $this
     */
     ...
     *
     * @param string $sourceBusinessEventType The type of event.  Possible values:  * `LoanAdvance`  * `LoanPayment`  * `LoanRefund`
     *
     * @return $this
     */
