...
/**
 * ItemProceedsDetailedBreakdown Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ItemProceedsDetailedBreakdown implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ItemProceedsDetailedBreakdown';
    ...
    protected static $swaggerTypes = [
        'subtype' => 'string',
        'value' => '\SellingPartnerApi\Model\Orders20260101\Money'
    ];
     ...
     * Sets subtype
     *
     * @param string $subtype Specific classification of the further granular breakdown.   **Possible values**: `ITEM`, `SHIPPING`, `GIFT_WRAP`, `COD_FEE`, `OTHER`, `DISCOUNT`
     *
     * @return $this
     */
     ...
     * Sets value
     *
     * @param \SellingPartnerApi\Model\Orders20260101\Money $value value
     *
     * @return $this
     */
