...
class CustomerAddress implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'countryCode' => 'string',
        'phone' => 'string',
        'extendedFields' => '\SellingPartnerApi\Model\Orders20260101\AddressExtendedFields',
        'addressType' => 'string'
    ];
     ...
     * Sets phone
     *
     * @param string $phone The contact phone number for delivery coordination and customer communication.  **Note**: The buyer phone number will be suppressed in some cases, including but not limited to:  - All FBA (Fulfillment by Amazon) orders. - Shipped FBM (Fulfilled by the merchant) orders when current date is past the latest delivery date.
     *
     * @return $this
     */
     ...
     * Gets extendedFields
     *
     * @return \SellingPartnerApi\Model\Orders20260101\AddressExtendedFields
     */
     ...
     * Sets extendedFields
     *
     * @param \SellingPartnerApi\Model\Orders20260101\AddressExtendedFields $extendedFields extendedFields
     *
     * @return $this
     */
     ...
     * Sets addressType
     *
     * @param string $addressType The type of location.  **Possible values**: `RESIDENTIAL`, `COMMERCIAL`, `PICKUP_POINT`
     *
     * @return $this
     */
