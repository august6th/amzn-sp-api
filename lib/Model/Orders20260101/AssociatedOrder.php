...
class AssociatedOrder implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param string $associationType The relationship between the current order and the associated order.  **Possible values**: `REPLACEMENT_ORIGINAL_ID`, `EXCHANGE_ORIGINAL_ID`
     *
     * @return $this
     */
