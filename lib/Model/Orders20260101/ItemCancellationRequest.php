...
/**
 * ItemCancellationRequest Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ItemCancellationRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ItemCancellationRequest';
     ...
     * Sets requester
     *
     * @param string $requester Entity that initiated the cancellation request for this item.   **Possible values**: `BUYER`
     *
     * @return $this
     */
