...
class SubmitShipmentConfirmationsRequest implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'shipmentConfirmations' => '\SellingPartnerApi\Model\VendorDirectFulfillmentShipping20211228\ShipmentConfirmation[]'
    ];
    ...
    {
        $this->container['shipmentConfirmations'] = isset($data['shipmentConfirmations']) ? $data['shipmentConfirmations'] : null;
    }
     ...
     *
     * @return \SellingPartnerApi\Model\VendorDirectFulfillmentShipping20211228\ShipmentConfirmation[]
     */
     ...
     *
     * @param \SellingPartnerApi\Model\VendorDirectFulfillmentShipping20211228\ShipmentConfirmation[] $shipmentConfirmations Array of `ShipmentConfirmation` objects. Each `ShipmentConfirmation` object represents the confirmation details for a specific shipment.
     *
     * @return $this
     */
