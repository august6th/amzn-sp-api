...
class DocumentDownload implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['downloadType'] = isset($data['downloadType']) ? $data['downloadType'] : null;
     ...
     * Sets expiration
     *
     * @param \DateTime $expiration The URI's expiration time. In [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) datetime format with pattern `yyyy-MM-ddTHH:mm:ss.sssZ`.
     *
     * @return $this
     */
