...
class Carrier implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['alphaCode'] = isset($data['alphaCode']) ? $data['alphaCode'] : null;
    ...
    {
        return $this->container['alphaCode'];
    }
    ...
    {
        $this->container['alphaCode'] = $alphaCode;
