...
class Order implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'orderDetails' => '\SellingPartnerApi\Model\VendorOrders\OrderDetails'
    ];
    ...
    protected static $setters = [
        ...
        'purchaseOrderState' => 'setPurchaseOrderState',
    ...
    protected static $getters = [
        ...
        'purchaseOrderState' => 'getPurchaseOrderState',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['purchaseOrderState'] = isset($data['purchaseOrderState']) ? $data['purchaseOrderState'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['purchaseOrderState'] === null) {
            $invalidProperties[] = "'purchaseOrderState' can't be null";
        }
        $allowedValues = $this->getPurchaseOrderStateAllowableValues();
        if (!is_null($this->container['purchaseOrderState']) && !in_array($this->container['purchaseOrderState'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'purchaseOrderState', must be one of '%s'",
    ...
    /**
     * Gets purchaseOrderState
     *
     * @return string
     */
    public function getPurchaseOrderState()
    {
        return $this->container['purchaseOrderState'];
    }

    /**
     * Sets purchaseOrderState
     *
    ...
    {
        $allowedValues = $this->getPurchaseOrderStateAllowableValues();
        if (!in_array($purchaseOrderState, $allowedValues, true)) {
        ...
        $this->container['purchaseOrderState'] = $purchaseOrderState;
     ...
     * Gets orderDetails
     *
     * @return \SellingPartnerApi\Model\VendorOrders\OrderDetails
     */
     ...
     * Sets orderDetails
     *
     * @param \SellingPartnerApi\Model\VendorOrders\OrderDetails $orderDetails orderDetails
     *
     * @return $this
     */
