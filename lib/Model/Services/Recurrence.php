...
class Recurrence implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'endTime' => '\DateTime',
        'daysOfWeek' => '\SellingPartnerApi\Model\Services\DayOfWeek[]',
        'daysOfMonth' => 'int[]'
    ];
     ...
     * Gets daysOfWeek
     *
     * @return \SellingPartnerApi\Model\Services\DayOfWeek[]
     */
     ...
     * Sets daysOfWeek
     *
     * @param \SellingPartnerApi\Model\Services\DayOfWeek[] $daysOfWeek Days of the week when recurrence is valid. If the schedule is valid every Monday, input will only contain `MONDAY` in the list.
     *
     * @return $this
     */
