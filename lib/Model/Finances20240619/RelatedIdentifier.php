 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RelatedIdentifier implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RelatedIdentifier';
    ...
    {
        $this->container['relatedIdentifierName'] = isset($data['relatedIdentifierName']) ? $data['relatedIdentifierName'] : null;
        $this->container['relatedIdentifierValue'] = isset($data['relatedIdentifierValue']) ? $data['relatedIdentifierValue'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['relatedIdentifierName']) && !in_array($this->container['relatedIdentifierName'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'relatedIdentifierName', must be one of '%s'",
