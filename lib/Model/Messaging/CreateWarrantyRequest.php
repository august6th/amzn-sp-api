...
class CreateWarrantyRequest implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['coverageStartDate'] = isset($data['coverageStartDate']) ? $data['coverageStartDate'] : null;
        $this->container['coverageEndDate'] = isset($data['coverageEndDate']) ? $data['coverageEndDate'] : null;
    }
     ...
     * Gets attachments
     *
     * @return \SellingPartnerApi\Model\Messaging\Attachment[]
     */
     ...
     * Sets attachments
     *
     * @param \SellingPartnerApi\Model\Messaging\Attachment[] $attachments Attachments to include in the message to the buyer. If any text is included in the attachment, the text must be written in the buyer's language of preference, which can be retrieved from the GetAttributes operation.
     *
     * @return $this
     */
